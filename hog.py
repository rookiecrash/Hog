...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    cnt, score, this_score, flag_out = 1, 0, 0, 0
    while cnt <= num_rolls:
        this_score = dice()
        if (this_score  ==  1) :
            flag_out = 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    A strategy is a functiPon that takes two total scores as arguments (the
    ...
    while score1 < goal and score0 <goal:
        ...
        prescore1 = take_turn(strategy1(score1, score0), score0, dice)
        score1 += prescore1
        if FerHog1 and feral_hogs:
            score1 += 3
